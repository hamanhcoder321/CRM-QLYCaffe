...
class DashboardController extends Controller
{
    ...
    {
        // ===== THỐNG KÊ TỔNG QUAN =====
        $tongLoHang    = \App\Models\Arrange::count();
        $tongDonNhap   = \App\Models\Shipment::count();
        $tongNhanVien  = \App\Models\User::where('status', 0)->count();
        $tongNCC       = \App\Models\Customer::count();

        // ===== BIỂU ĐỒ CỘT: Lô hàng nhập theo tháng (6 tháng gần nhất) =====
        $loHangTheoThang = \App\Models\Arrange::selectRaw('MONTH(created_at) as thang, YEAR(created_at) as nam, COUNT(*) as so_lo, IFNULL(SUM(total_arrange),0) as tong_gia_tri')
        ...
        $ketQuaLoHang = \App\Models\Arrange::selectRaw("
        ...
        $nvTheoBoPhan = \App\Models\User::join('parts', 'users.part_id', '=', 'parts.id')
